...
local _12952456875486445983783452227635151277232954895541 = Instance.new("ScreenGui")
_12952456875486445983783452227635151277232954895541.IgnoreGuiInset = false
...
sortinventory.Position = UDim2.new(0.25, 0, 0.0582792722, 0)
...
sortinventory.MouseButton1Click:Connect(function()
	...
	if bckpck.GoldHand and bckpck.MagicCarpet and bckpck.LaserGun then
		...
		sortinventory.Text = "you dont have the stuff"
		wait(1)
...
local tptobutton = Instance.new("TextButton")
tptobutton.Font = Enum.Font.FredokaOne
tptobutton.Text = "tp to button"
tptobutton.TextColor3 = Color3.new(1, 1, 1)
tptobutton.TextSize = 14
tptobutton.BackgroundColor3 = Color3.new(0.25098, 0.25098, 0.25098)
tptobutton.BorderColor3 = Color3.new(0, 0, 0)
tptobutton.BorderSizePixel = 0
tptobutton.Position = UDim2.new(0.5, 0, 0.0582792722, 0)
tptobutton.Size = UDim2.new(0, 85, 0, 21)
tptobutton.Visible = true
tptobutton.ZIndex = 2
tptobutton.Name = "tp to button"
tptobutton.Parent = frame
tptobutton.MouseButton1Click:Connect(function()
	local hrp = localplr.Character:FindFirstChild("HumanoidRootPart")
	hrp.CFrame = CFrame.new(766.5, 198.499954, 55.4999924, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)
local uicorner_8 = Instance.new("UICorner")
uicorner_8.CornerRadius = UDim.new(0, 10)
uicorner_8.Parent = tptobutton

local drop_shadow_holder_2 = Instance.new("Frame")
drop_shadow_holder_2.BackgroundTransparency = 1
drop_shadow_holder_2.BorderSizePixel = 0
drop_shadow_holder_2.Size = UDim2.new(1, 0, 1, 0)
drop_shadow_holder_2.Visible = true
drop_shadow_holder_2.ZIndex = 2
drop_shadow_holder_2.Name = "DropShadowHolder"
drop_shadow_holder_2.Parent = tptobutton

local drop_shadow_7 = Instance.new("ImageLabel")
drop_shadow_7.Image = "rbxassetid://6014261993"
drop_shadow_7.ImageColor3 = Color3.new(0, 0, 0)

drop_shadow_7.ImageTransparency = 0.6399999856948853
drop_shadow_7.ScaleType = Enum.ScaleType.Slice
drop_shadow_7.SliceCenter = Rect.new(49, 49, 450, 450)
drop_shadow_7.AnchorPoint = Vector2.new(0.5, 0.5)
drop_shadow_7.BackgroundTransparency = 1
drop_shadow_7.BorderSizePixel = 0
drop_shadow_7.Position = UDim2.new(0.5, 0, 0.5, 0)
drop_shadow_7.Size = UDim2.new(1, 25, 1, 30)
